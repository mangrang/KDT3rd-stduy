...
// 변수
// - 변할 수 있는 수. 정해진 값이 아닌 수. variavle
// - 데이터 보관함
// - 어떤 값으 저장하기 위한 메모리 공간을 "식별"하고자 붙인 이름
...
console.log('q2의 값은 '+q2+'입니다');
 
// Q3. 다음 코드 실행시 q3 변수는 어떤 값이 될까? error
const q3 = 1;
// q3 = q3 + 1; // error: q3값은 재할당이 불가능한 변수 (const 선언)
console.log('q3의 값은 error 입니다');
...
// 식별자 규칙
//  1. 키워드 사용 불가능
//   - 키워드: 특별한 역활을 이미 하고 있는 단어
//   - ex. cosnt, var, let, void, return, for, while, if, else..
//  2. 숫자로 시작 x
//  3. 특수문자: _, $ 만 허용
//  4. 공백 문자 (space bar) x


// [Quiz] 다으 중 식별자 가능한 것은?
// apple o
// 1apple x
// let x
// $apple o
...
// javascript 다른 언어와 달리 인터프리터(해석기)가 알아서 변수의 탑입을
...
console.log(typeof(null)); // object 공식 오류
console.log(typeof '문자') //string
